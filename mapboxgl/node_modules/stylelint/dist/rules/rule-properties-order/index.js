...
exports.default = function (expectation, options) {
  return function (root, result) {
    ...
    result.warn("'rule-properties-order' has been deprecated " + "and in 5.0 it will be removed. " + "Use 'declaration-block-properties-order' instead.", {
    ...
    var someEmptyLineBeforeIsBoolean = _lodash2.default.some(expectation, function (group) {
      return _lodash2.default.isBoolean(_lodash2.default.get(group, "emptyLineBefore"));
    });
    if (someEmptyLineBeforeIsBoolean) {
      result.warn("In 'rule-properties-order', the value 'true' for 'emptyLineBefore' has been deprecated " + "and in 5.0 it will be removed. " + "Use 'always' or 'never' instead.", {
        stylelintType: "deprecation",
    ...
    function checkNode(node) {
      ...
      function checkOrder(firstPropData, secondPropData) {
        ...
        if (firstPropSeparatedGroup !== secondPropSeparatedGroup) {
          ...
          var emptyLineBefore = _lodash2.default.get(groups[secondPropData.orderData.separatedGroup - 2], "emptyLineBefore");
...
var ruleName = exports.ruleName = "rule-properties-order";
...
var messages = exports.messages = (0, _utils.ruleMessages)(ruleName, {
  ...
  unexpectedEmptyLineBetween: function unexpectedEmptyLineBetween(first, second) {
