...
exports.default = function (actual) {
  return function (root, result) {
    ...
    result.warn("'rule-no-duplicate-properties' has been deprecated " + "and in 5.0 it will be removed. " + "Use 'declaration-block-no-duplicate-properties' instead.", {
...
var ruleName = exports.ruleName = "rule-no-duplicate-properties";
