...
exports.default = function (actual) {
  return function (root, result) {
    ...
    root.walkRules(function (rule) {
      ...
      var contextSelectorSet = selectorContextLookup.getContext(rule, (0, _utils.findMediaContext)(rule));
      ...
      var normalizedSelectorList = resolvedSelectors.map(normalizeSelector);
      ...
      rule.selectors.forEach(function (selector, i) {
        if ((0, _lodash.includes)(normalizedSelectorList.slice(0, i), normalizeSelector(selector))) {
          (0, _utils.report)({
            result: result,
            ruleName: ruleName,
            node: rule,
