...
methods; distances previously in kilometres now in metres, order of arguments to destination point
methods reversed.*
...
Generic 3-d vector functions, not tied to geodosy applications.
...
Usage in browser using `<script>` tags, eg for UTM conversions:
    ...
    <script>
        ...
        console.log(Dms(latlon, 'dms', 2)); // => '13°24′45.00″N, 103°52′00.00″E'
    </script>
