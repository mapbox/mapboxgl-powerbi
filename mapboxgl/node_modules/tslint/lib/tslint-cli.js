...
var processFile = function (file) {
    ...
    var configurationPath = configuration_1.findConfigurationPath(argv.c, file);
    var configuration = configuration_1.loadConfigurationFromPath(configurationPath);
    var configurationDir = path.dirname(configurationPath);
    var rulesDirectories = configuration_1.getRulesDirectories(configuration.rulesDirectory, configurationDir);
    if (argv.r != null) {
