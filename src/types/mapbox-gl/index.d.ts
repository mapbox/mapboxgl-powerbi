...
declare namespace mapboxgl {
	...
	export class Map extends Evented {
		...
		fitBounds(bounds: LngLatBoundsLike, options?: { linear?: boolean, easing?: Function, padding?: number | mapboxgl.PaddingOptions, offset?: PointLike, maxZoom?: number, duration: number }, eventData?: mapboxgl.EventData): this;
